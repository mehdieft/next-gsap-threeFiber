            ...
            <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl overflow-hidden border border-[#dedbd2] bg-white shadow-[0_24px_80px_rgba(35,44,31,0.12)] lg:min-h-[calc(100vh-4rem)] lg:grid-cols-[1.05fr_0.95fr]">
                <section className="relative hidden overflow-hidden bg-[#25463a] p-12 text-[#fbfaf6] lg:flex lg:flex-col">
                    ...
                    <div className="relative z-10 my-auto max-w-md pt-20">
                        ...
                        <p className="mt-6 max-w-sm text-base leading-7 text-[#d8e0d8]">
                            وارد حساب کاربری خود شوید، موارد ذخیره‌شده را ببینید، سفارش‌ها را پیگیری کنید و تازه‌ها را کشف کنید.
                        </p>
                    </div>
                ...
                <section className="flex min-h-[calc(100vh-2rem)] flex-col px-6 py-8 sm:px-12 sm:py-10 lg:min-h-0 lg:px-16 lg:py-12">
                    ...
                    <div className="my-auto w-full max-w-md py-12 lg:py-0">
                        ...
                        <h2 className="mt-3 text-3xl font-semibold tracking-tight text-[#1d2939]">ورود به حساب کاربری</h2>
                        <p className="mt-3 text-sm leading-6 text-[#667085]">برای ادامه، اطلاعات حساب خود را وارد کنید.</p>

                        <form className="mt-9 space-y-5">
                            <div>
                                <label htmlFor="email" className="mb-2 block text-sm font-semibold text-[#344054]">آدرس ایمیل</label>
                                <input
                                    id="email"
                                    name="email"
                                    type="email"
                            ...
                            <div>
                                <div className="mb-2 flex items-center justify-between gap-3">
                                    <label htmlFor="password" className="text-sm font-semibold text-[#344054]">رمز عبور</label>
                                    <a href="#forgot-password" className="text-sm font-semibold text-[#356250] underline decoration-[#356250]/35 underline-offset-4 transition hover:text-[#1f4034]">رمز عبور را فراموش کرده‌اید؟</a>
                                </div>
                        ...
                        <p className="mt-8 text-center text-sm text-[#667085]">
                            تازه به نورث‌لاین آمده‌اید؟ <a href="#create-account" className="font-semibold text-[#356250] underline decoration-[#356250]/35 underline-offset-4 transition hover:text-[#1f4034]">ایجاد حساب کاربری</a>
                        </p>
                    </div>

                    <p className="text-center text-xs text-[#98a2b3] lg:text-right">محافظت‌شده با رمزنگاری امن</p>
                </section>
            </div>
        </main>
    );
