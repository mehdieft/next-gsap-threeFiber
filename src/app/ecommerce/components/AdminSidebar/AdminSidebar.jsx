...
const icons = {
  ...
  shipping:     "M5 17H3a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v3M16 3h5l2 5-2 5h-5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zM10 17a2 2 0 1 0 0 4 2 2 0 0 0 0-4zM20 17a2 2 0 1 0 0 4 2 2 0 0 0 0-4z",
  discounts:    "M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82zM7 7h.01",
  ...
  integrations: "M12 2a5 5 0 0 1 5 5v2a5 5 0 0 1-10 0V7a5 5 0 0 1 5-5zM2 17c0-3 2.5-5 5-5h10c2.5 0 5 2 5 5v4H2v-4z",
...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { label: "Orders",    href: "/ecommerce/admin/orders",    icon: <SVGIcon path={icons.orders} />,    badge: 14, badgeVariant: "red" },
      { label: "Products",  href: "/ecommerce/admin/products",  icon: <SVGIcon path={icons.products} /> },
      { label: "Customers", href: "/ecommerce/admin/customers", icon: <SVGIcon path={icons.customers} /> },
    ],
  },
  {
    title: "Store",
    items: [
      { label: "Shipping",  href: "/ecommerce/admin/shipping",  icon: <SVGIcon path={icons.shipping} /> },
      { label: "Discounts", href: "/ecommerce/admin/discounts", icon: <SVGIcon path={icons.discounts} />, dot: true },
      { label: "Payments",  href: "/ecommerce/admin/payments",  icon: <SVGIcon path={icons.payments} /> },
      { label: "Reviews",   href: "/ecommerce/admin/reviews",   icon: <SVGIcon path={icons.reviews} />,   badge: 3, badgeVariant: "gray" },
    ],
  },
  {
    title: "Insights",
    items: [
      { label: "Analytics", href: "/ecommerce/admin/analytics", icon: <SVGIcon path={icons.analytics} /> },
      { label: "Reports",   href: "/ecommerce/admin/reports",   icon: <SVGIcon path={icons.reports} /> },
    ],
  },
  {
    title: "System",
    items: [
      { label: "Integrations", href: "/ecommerce/admin/integrations", icon: <SVGIcon path={icons.integrations} /> },
      { label: "Settings",     href: "/ecommerce/admin/settings",     icon: <SVGIcon path={icons.settings} /> },
    ],
  },
];
...
function NavLink({ item }) {
  ...
  return (
    ...
    >
      ...
      {item.dot && (
        <span className="w-1.5 h-1.5 rounded-full bg-red-500 shrink-0" aria-label="new" />
      )}
    </Link>
  );
}
...
export default function AdminSidebar() {
  return (
    <aside className="w-[220px] min-w-[220px] h-[92vh] flex flex-col bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800">
      ...
      <div className="px-3 pt-3.5 pb-2.5 border-b border-zinc-200 dark:border-zinc-800">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-[13px] font-medium text-zinc-900 dark:text-zinc-100 tracking-tight">ShopOS</span>
        ...
        <button className="flex items-center gap-1.5 w-full px-2 py-1.5 rounded-md border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors">
          ...
          <span className="text-[11px] text-zinc-500 dark:text-zinc-400 flex-1 text-left">Main store</span>
          <SVGIcon path={icons.chevronDown} size={12} />
        </button>
      </div>

      {/* Nav sections */}
      <nav className="flex-1 overflow-y-auto px-2 py-2 space-y-4" aria-label="Sidebar navigation">
      ...
      <div className="px-2 py-2 border-t border-zinc-200 dark:border-zinc-800">
        <button className="flex items-center gap-2 w-full px-2 py-1.5 rounded-md hover:bg-white dark:hover:bg-zinc-800 transition-colors">
          ...
          <div className="flex-1 text-left min-w-0">
            <p className="text-[11px] font-medium text-zinc-900 dark:text-zinc-100 truncate">Ali Karim</p>
            <p className="text-[10px] text-zinc-400 dark:text-zinc-500">Super admin</p>
          </div>
