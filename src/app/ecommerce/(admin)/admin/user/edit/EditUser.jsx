...
import { updateUserAction } from "@/app/ecommerce/actions/userActions";
    ...
    <>
      <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
        <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl shadow-gray-200/50 p-8 md:p-12 transition-all duration-300 hover:shadow-gray-300/50">
          ...
          <form action={updateUserAction.bind(null,user.id)} className="space-y-8">
            <input disabled className="hidden" value={user.id} name="id" />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-4 py-3.5 pl-11 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 outline-none appearance-none cursor-pointer hover:border-gray-300"
                  >
