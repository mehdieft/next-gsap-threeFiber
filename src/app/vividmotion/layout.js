  ...
  return (
    <div className={samim.className}>
      ...
      >
        ...
        <div
          dir="rtl"
          className="relative z-10 min-h-screen w-full p-5 sm:p-6 md:p-8 bg-transparent flex flex-col gap-5 overflow-hidden text-white"
        >
          {/* BACKGROUND */}
          <FooterBlob />
          ...
          <div className="absolute bottom-4 sm:bottom-6 md:bottom-10 inset-x-0 text-white text-[14vw] sm:text-[12vw] md:text-[10vw] italic leading-none text-center whitespace-nowrap">
            ویوید موشن
          </div>
        </div>
      </ReactLenis>
