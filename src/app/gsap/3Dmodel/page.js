...
export default function ThreeDmodel() {
  ...
  useGSAP(() => {
    ...
    [...description.lines, ...titleSplites.lines].forEach((line) => {
    ...
    ScrollTrigger.create({
      ...
      onUpdate: ({progress}) => {
        ...
        const header2Percent=progress <0.15 ? 100 :progress>0.5?-200 :100*header2progress;
        gsap.to('.header-2',{
  ...
  return (
    ...
    <div ref={containerRef}>
      ...
      <section className="relative w-[100vw] h-svh bg-amber-50 text-black product-overwiew">
        <div className="header-1 w-[200vw]  flex items-center h-svh translate-x-0">
          <h1 className="bg-yellow-400">every thing is a bitch</h1>
        </div>
        <div className="header-2 flex items-center fixed top-0 text-8xl bg-purple-500 left-0 w-[150vw] h-svh translate-x-full">
        ...
        <div className="tooltips absolute top-[50%] right-[50%] translate-x-[50%] translate-y-[-50%] w-3/4 h-3/4 flex gap-[1rem] ">
          <div className="tooltip flex flex-col gap-4 bg-purple-400">
            <div className="icons"></div>
            <div className=" divider relative w-full h-px bg-green-800 m-[0.5rem 0] scale-x-0 origin-[100%_50%]"></div>
            <div className="title">
              <h1>build to last</h1>
            </div>
          ...
          <div className="tooltip flex flex-col justify-end items-end bg-green-400 ">
            <div className="icons"></div>
            <div className="divider relative w-full h-px bg-green-800 m-[0.5rem 0] scale-x-0 origin-[100%_50%] "></div>
            <div className="title">
              <h1>build to last</h1>
