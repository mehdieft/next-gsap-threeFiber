...
export default function Toast({ message, type = TOAST_TYPE.sucess }) {
  ...
  return (
      ...
      <div ref={container} className={clsx('px-8 py-3 p-3 will-change-transform flex flex-col fixed top-4 right-4 rounded-2xl shadow-2xl',type==='success'?'bg-green-200 text-green-900':'',
        type==='error'?'bg-red-200 text-red-900':'' )}>
        <h1 className=" text will-change-opacity flex justify-center items-center text-center gap-3 font-bold text-sm">
